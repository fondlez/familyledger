...
Alternatively, if you know Python, it is available via ``pip install familyledger`` on the official Python `PyPi package index <https://pypi.org/project/FamilyLedger/>`.
